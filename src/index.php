...
$resultado = $mysqli->query("SELECT * FROM DeadSpace ORDER BY apellido, nombre");
...
Este forma de pasar el dato se conoce como: método GET*/
		...
		echo "<a href=\"delete.php?idempleado=$fila[id]\" onClick=\"return confirm('¿Está segur@ que desea eliminar el personaje?')\" >Baja</a></td>\n";
		echo "</td>";
		echo "</tr>\n";
	}//fin mientras
 }//fin si
